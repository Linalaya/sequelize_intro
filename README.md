...
*пример сидера из моего файла (не внесены createdAt: new Date() и updatedAt: new Date()) ---
--- вероятно потому, что в миграции этой модели в графах createdAt и updatedAt указано значение по умолчанию:
createdAt: {
        allowNull: false,
        type: Sequelize.DATE,
